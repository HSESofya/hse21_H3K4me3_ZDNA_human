...
peaks <- toGRanges(paste0('H3K4me3_K562.intersect_with_DeepZ.bed'), format="BED")
peaks[1:2]
...
write.table(anno_df, file=paste0('H3K4me3_K562.intersect_with_DeepZ.genes.txt'),
            col.names = TRUE, row.names = FALSE, sep = '\t', quote = FALSE)

uniq_genes_df <- unique(anno_df['symbol'])
write.table(uniq_genes_df, file=paste0('H3K4me3_K562.intersect_with_DeepZ.genes_uniq.txt'),
